...
public class SalesDetails {
	...
	public SalesDetails(Integer detailsId, String cardType,Integer denomination, Integer bulkNo, Integer noOfCards,String startSerial, Double lineAmount, Double lineDiscount,Long invoiceId) {
		super();
