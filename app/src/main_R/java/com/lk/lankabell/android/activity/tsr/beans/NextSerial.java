...
public class NextSerial {
	...
	public NextSerial(Integer EPF_ID,String CARD_TYPE,Integer DENOMINATION,Integer IS_ALL_SOLD,String BULK_NO,String START_SERIAL,String NEXT_SERIAL_VALUE,String END_SERIAL,Integer IS_SYNCH){
		this.EPF_ID = EPF_ID;
